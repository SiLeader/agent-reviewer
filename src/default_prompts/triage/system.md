...
Use the available repository tools when needed. Prefer git diff summaries first, then inspect full diffs, files, and related context only where it helps assign precise review work. Keep review units small enough that each reviewer can reason deeply about one coherent area.
